...
const techs = [
  ...
  { icon: <SiNextdotjs color="#000" size={50} />, name: "NEXT" },
  { icon: <SiExpress color="#000" size={50} />, name: "EXPRESS" },
  ...
  { icon: <SiGit color="#F05032" size={50} />, name: "GIT" },
  { icon: <SiGithub color="#181717" size={50} />, name: "GITHUB" },
];

export default function TechStack() {
  return (
    <section className="flex flex-col justify-center items-center gap-20 px-4 py-10 w-full overflow-hidden">
