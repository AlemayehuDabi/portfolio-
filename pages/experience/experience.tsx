...
const milestones: CareerMilestone[] = [
  {
    ...
    type: 'main',
    achievements: [
      'Led development of high-scale distributed systems serving 1M+ requests/sec',
      'Reduced infrastructure costs by 40% through strategic optimizations',
      'Mentored 5 junior engineers, driving team velocity increase of 30%',
    ],
    tech: ['TypeScript', 'Go', 'AWS', 'Kubernetes', 'DynamoDB'],
    color: 'cyan-glow',
  },
  {
    id: 'startup-venture',
    ...
    achievements: [
      ...
      'Raised $2M seed funding from tier-1 VCs',
  ...
  },
  {
    ...
    achievements: [
      ...
      'Improved API latency by 60% through caching strategies',
      'Led cross-team initiatives for service integration',
    ],
    tech: ['Java', 'AWS Lambda', 'SQS', 'CloudFormation'],
    color: 'emerald-glow',
  },
  {
    id: 'freelance',
  ...
  },
  {
    ...
    type: 'main',
    achievements: [
      'Contributed to Google Cloud Platform tooling',
      'Implemented feature flags system used by 100+ teams',
      'Received return offer and strong performance rating',
    ],
    tech: ['Python', 'Go', 'GCP', 'Protocol Buffers'],
    color: 'rose-glow',
  },
  {
    id: 'university',
    ...
    tech: ['C++', 'Python', 'Machine Learning', 'Algorithms'],
    color: 'cyan-glow',
  },
];
